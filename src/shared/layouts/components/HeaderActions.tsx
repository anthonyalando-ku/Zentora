...
/**
 * Desktop-only header actions: Account + Cart.
 * The mobile-menu toggle has moved out of this component — on mobile
 * the hamburger lives in the new left cluster inside Header.tsx, so this
 * component is now rendered exclusively in the desktop branch.
 */
export const HeaderActions = ({ cartCount }: HeaderActionsProps) => (
