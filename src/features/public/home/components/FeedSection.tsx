...
const FeedSection = ({ feedType, items, isLoading, isError }: FeedSectionProps) => {
  // "See all" now links to the dedicated collection page
  const seeAllHref = `/collections/${feedType}`;
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="rounded-xl border border-border overflow-hidden">
          <div className="flex items-center gap-3 px-5 py-3 border-b border-border bg-background">
            ...
            <Link to={seeAllHref} className="ml-auto text-xs font-medium text-primary/50">See all</Link>
          </div>
